...
// Begin JS library code
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(7, 0, 1, len, prot, flags, fd, offset, allocated, addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(8, 0, 1, addr, len, prot, flags, fd, offset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(28, 0, 1, fd, offset, whence, newOffset);
...
var ASM_CONSTS = {
  102300: () => { if (document.fullscreenElement) return 1; },  
 102346: () => { return document.getElementById('canvas').width; },  
 102398: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102466: () => { document.exitFullscreen(); },  
 102493: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 102566: () => { if (document.fullscreenElement) return 1; },  
 102612: () => { return document.getElementById('canvas').width; },  
 102664: () => { return screen.width; },  
 102689: () => { document.exitFullscreen(); },  
 102716: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102849: () => { return window.innerWidth; },  
 102875: () => { return window.innerHeight; },  
 102902: () => { if (document.fullscreenElement) return 1; },  
 102948: () => { return document.getElementById('canvas').width; },  
 103000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103068: () => { if (document.fullscreenElement) return 1; },  
 103114: () => { return document.getElementById('canvas').width; },  
 103166: () => { return screen.width; },  
 103191: () => { return window.innerWidth; },  
 103217: () => { return window.innerHeight; },  
 103244: () => { if (document.fullscreenElement) return 1; },  
 103290: () => { return document.getElementById('canvas').width; },  
 103342: () => { return screen.width; },  
 103367: () => { document.exitFullscreen(); },  
 103394: () => { if (document.fullscreenElement) return 1; },  
 103440: () => { return document.getElementById('canvas').width; },  
 103492: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103560: () => { document.exitFullscreen(); },  
 103587: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 103645: () => { return screen.width; },  
 103670: () => { return screen.height; },  
 103696: () => { return window.screenX; },  
 103723: () => { return window.screenY; },  
 103750: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103803: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103874: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103931: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104187: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 104258: () => { if (document.fullscreenElement) return 1; },  
 104304: () => { return window.innerWidth; },  
 104330: () => { return window.innerHeight; },  
 104357: () => { if (document.pointerLockElement) return 1; }
};
